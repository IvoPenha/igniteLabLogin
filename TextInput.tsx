...
function TextInputDiv(props: TextInputDivProps){
    ...
    <div
    className={clsx(
        '  flex rounded px-4 py-3  focus-within:ring ring-cyan-300  bg-gray-800 outline-none  w-80')}>
        {props.children}
    </div>
    )
}
...
function TextInputInput(props: TextInputProps){
    return(
        ...
        <input  className={clsx(' flex-1 pl-4 bg-transparent outline-none text-gray-100 text-xs placeholder:text-gray-200' )}
        {...props}
        />
    )
} 
